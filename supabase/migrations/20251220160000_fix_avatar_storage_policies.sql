...
-- Users can only upload a file named "{uid}.png"
...
-- Policy 3: Authenticated User Update (Update)
-- Users can only update their own file named "{uid}.png"
...
-- Policy 4: Authenticated User Delete (Delete)
-- Users can only delete their own file named "{uid}.png"
